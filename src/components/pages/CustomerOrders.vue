            ...
            <validation-observer class="col-md-6" v-slot="{ invalid }">
                <form  @submit.prevent="createOrder">
                    <validation-provider  rules="required|email" v-slot="{ errors, classes }">
                        <!-- 此input規則為 required:必填欄位  email:格式為email -->
                    ...
                    <validation-provider  rules="required" v-slot="{ errors, classes }">
                        <div class="form-group">
                            ...
                            <input id="收件人姓名" type="text" name="收件人姓名" v-model="form.user.name"
                                class="form-control" :class="classes">
                            <!-- 錯誤訊息 -->
                            <span class="invalid-feedback">{{ errors[0] }}</span>
                        </div>
                    ...
                    <validation-provider  rules="required|numeric|min:8" v-slot="{ errors, classes }">
                        <div class="form-group">
                            ...
                            <input id="電話" type="tel" v-model="form.user.tel"
                                class="form-control" :class="classes">
                            <!-- 錯誤訊息 -->
                            <span class="invalid-feedback">{{ errors[0] }}</span>
                        </div>
                    ...
                    <validation-provider  rules="required|min:8" v-slot="{ errors, classes }">
                        <div class="form-group">
                            ...
                            <input name="地址" id="useraddress" type="text" v-model="form.user.address"
                                class="form-control" :class="classes">
                            <!-- 錯誤訊息 -->
                            <span class="invalid-feedback">{{ errors[0] }}</span>
                        </div>
